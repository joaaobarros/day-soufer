...
const trabalhos = [
  ...
  },
  {
    ...
    desc: "Programação integrada reunindo as principais instituições de formação em dança de Fortaleza. No Dia Internacional da Dança, Day leva estudantes de todas as idades ao Theatro José de Alencar. Porque dançar é um direito, não um privilégio.",
  ...
  },
  {
    ...
    desc: "Pesquisa sobre pedagogia da dança em contexto virtual. Como construir presença e escuta à distância? O estudo investigou modos de manter o vínculo pedagógico durante o distanciamento. E descobriu que o corpo sempre acha um caminho.",
  ...
  },
  {
    ...
    desc: "Professora de Dança Clássica e Abordagens Técnicas. Ensino público e gratuito. Formação de corpos que não teriam acesso de outra forma. A Vila das Artes como território de pertencimento artístico e prova de que a dança é para todos.",
  ...
  },
  {
    ...
    desc: "Dança na periferia. O Bom Jardim como território legítimo de criação artística. Cada aula é uma aposta: o endereço de nascimento não define o acesso à formação.",
  ...
  },
  {
    ...
    desc: "Musculação em Casa e Danças. Treino e alegria não são coisas separadas. Uma prova diária de que o humor também é político e que o corpo que ri também está se formando. O projeto une técnica, improviso e bom-humor como método.",
